<?php
  ...
  class DB_helper{
    ...
    public function insert_table($arr_col,$tb_name,$data_example){
    ...
    public function insert_tb_header($tb_header,$tb_name){ // field => column_order เริ่มที่ 1 เนื่องจาก 0 คือ primary key ของตาราง
