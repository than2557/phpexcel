...
<div class="container">
    <form action="" class="form-horizontal"  role="form">
        ...
        <div class="form-group">
            ...
            <input type="text"  class=" form-control control-label col-sm-1" style="width: 200px;">
        ...
        <div class="col-sm-12">
            ...
            <input  type="file" name="upload" class=" form-control control-label col-sm-1" style="width: 200px;">
        </div>
            ...
            <div class="form-group">
                ...
                <div class="input-group date form_datetime col-md-4" data-date="1979-09-16T05:25:07Z" data-date-format="dd MM yyyy - HH:ii p" data-link-field="dtp_input1">
                    <input class="form-control col-sm-2" size="16" type="text" value="" style="width:200px;">
