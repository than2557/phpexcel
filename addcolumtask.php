...
<a  style="width:45%;" class="w3-round"></a><br><br>
  ...
  <img src="https://plms.pea.co.th/Personal/EmployeeImage?EmpCode=<?php echo $_SESSION['username']; ?>"   style="width:45%;height:18%;" class="w3-round"  alt="picture"/>
...
<card class="neumorphic" style="margin-top:-15%;width:300px;height:100px;"><h2 style="margin-left:15%;">เพิ่มคอลัมน์งาน</h2></card>
